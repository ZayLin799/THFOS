              ...
              <div class="card rounded-3">
                <div class="card-body">
                  ...
                  <form action="{{route('volunteer.store')}}" method="POST">
                    ...
                    {{-- <div class="mb-3 form-group">
                      <label class="form-label" for="pos">Which position do you want to apply?</label>
                    ...
                    <div class=" collapse {{ (old('pos') == 'teacher') ? 'show' : ''}} chosen_hiden chosen_teacher">
                      ...
                      <div class="mb-3 form-group">
                        ...
                        {{-- <div class="mb-3 form-group">
                          <label for="reason" class="form-label">Why do you want to teach at our school?</label>
                ...
                <br/> 
                    <div class="d-flex justify-content-around">
                          <a href="{{url('volunteer')}}" class="btn btn-secondary mb-1 col-4">Back</a>
