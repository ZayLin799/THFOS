                  ...
                  <form action="{{route('course.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="form-group">
                        <select class="form-control form-control-md" aria-label="Default select example" name="course_category_id">
                          <option value="{{ $category->id }}" selected>{{ $category->course_category_name }}</option>
                        </select>
                      </div>
                    </div>
                    <div class="mb-3">
